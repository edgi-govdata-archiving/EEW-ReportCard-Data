...
effluentgraph <- ggplot(effluentviolations, mapping=aes(x=factor(Year),
  ...
  theme(axis.text.x=element_text(size=9),
        axis.title.x = element_blank(), plot.subtitle = element_text(hjust=.5, size=10, color="green"), plot.title = 
...
<p style="text-align: right;">[`r na.omit(CAAbadactors[8,7]) `](`r na.omit(CAAbadactors[9,4]) `)<br /></p>
<p style="text-align: right;">[`r na.omit(CAAbadactors[8,7]) `](`r na.omit(CAAbadactors[10,4]) `)<br /></p>
...
<p style="text-align: right;">[`r na.omit(RCRAbadactors[8,7]) `](`r na.omit(RCRAbadactors[9,4]) `)<br /></p>
<p style="text-align: right;">[`r na.omit(RCRAbadactors[8,7]) `](`r na.omit(RCRAbadactors[10,4]) `)<br /></p>
