...
effluentgraph <- ggplot(effluentviolations, mapping=aes(x=factor(Year), 
  ...
  scale_fill_manual(values=president_colors,guide=guide_legend(breaks=c("Bush","Obama","Trump","Biden")))+
