...
region <- u$Region(type='Congressional District', value='34', state='TX', programs=c('CAA', 'CWA', 'RCRA'))
...
# SH - activefacilities <- `active-facilities_All_pg3_TX-34`
...
# SH CWAviolations <- `violations_CWA_pg6_TX-34`
names(CWAviolations)[2] <- "Count"
names(CWAviolations)[1] <- "Year"  # SH
# SH - CWAviolations <- CWAviolations[-c(20),]
...
# SH - enforcement <- `enforcements_All_pg3_TX-34`
names(enforcement)[1] <- "Year"
# SH - enforcement <- enforcement[-c(20),]
...
ggsave("dotplot_TX34.png", dotplot, path=here("Output/TX34"), scale = 2, width=8, height=5, units=c("cm"))

```
 
<a ><img src="Output/TX34/dotplot_TX34.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
...
# SH - CAArecurring <- `recurring-violations_All_pg3_TX-34`[-c(2,3,5,6),]
...
# SH - CAArecurring$Region2 <- as.character("All of OR")
...
##first let's fix up the data
#ok so We'll put the % in the title for the state, and try to figure out the same for TX 34
# SH - CWArecurring <- `recurring-violations_All_pg3_TX-34`[-c(1,3,4,6),]
...
##first let's fix up the data
#ok so We'll put the % in the title for the state, and try to figure out the same for TX 34
# SH - RCRArecurring <- `recurring-violations_All_pg3_TX-34`[-c(1,2,4,5),]
...
#[9:11,2] Obama
# [17:19,2] Trump
# SH - effluentviolations <- `violations_CWA_pg3_TX-34`
# SH - effluentviolations <- effluentviolations[-c(20),]
...
#[9:11,2] Obama
# [17:19,2] Trump
# SH - inspections <- `inspections_All_pg3_TX-34`
...
# SH - names(`inspectionsper1000_All_pg4_TX-112920.csv`)[2] <- "Inspectionsper1000"
# SH - `inspectionsper1000_All_pg4_TX-112920.csv`$Region <- as.factor("State")
# SH - names(`inspectionsper1000_All_pg4_TX-34`)[2] <- "Inspectionsper1000"
# SH - `inspectionsper1000_All_pg4_TX-34`$Region <- as.factor("Congressional District")
# SH - inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_TX-112920.csv`, `inspectionsper1000_All_pg4_TX-34`)
...
# SH - names(`violationsper1000_All_pg4_TX-112920.csv`)[2] <- "violationsper1000"
# SH - `violationsper1000_All_pg4_TX-112920.csv`$Region <- as.factor("State")
# SH - names(`violationsper1000_All_pg4_TX-34`)[2] <- "violationsper1000"
# SH - `violationsper1000_All_pg4_TX-34`$Region <- as.factor("Congressional District")
# SH - violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_TX-112920.csv`, `violationsper1000_All_pg4_TX-34`)
...
# SH - CAAbadactors <- `noncomp_CAA_pg6_TX-34`
# SH - CAAbadactors <-CAAbadactors[!(CAAbadactors$noncomp_count==0),]
...
if ( nrows_caa > 0 ) {
  ...
  ggsave("CAAfacilities.png", CAAfacilities, path=here("Output/TX34"), scale = 3, width=7, height=4, units=c("cm"))
}

#call in data and clean up 
# SH - RCRAbadactors <- `noncomp_RCRA_pg7_TX-34`
# SH - RCRAbadactors <-RCRAbadactors[!(RCRAbadactors$noncomp_count==0),]
...
if ( nrows_rcra > 0 ) {
  ...
  ggsave("RCRAfacilities.png", RCRAfacilities, path=here("Output/TX34"), scale = 3, width=7, height=4, units=c("cm"))
}

#call in data and clean up 
# SH - CWAbadactors <- `noncomp_CWA_pg6_TX-34`
# SH - CWAbadactors <-CWAbadactors[!(CWAbadactors$noncomp_count==0),]
...
if ( nrows_cwa > 0 ) {
  ...
  ggsave("CWAfacilities.png", CWAfacilities, path=here("Output/TX34"), scale = 3, width=7, height=4, units=c("cm"))
}
...
`r if ( nrows_caa == 0) { 
    ...
    "<br /><a ><img src=\"Output/TX34/CAAfacilities.png\" style=\"float: left; width: 55%; 
...
`r if ( nrows_rcra == 0) { 
    ...
    "<br /><a ><img src=\"Output/TX34/RCRAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**ECHO reports for facilities:**</font><font size=\"1.5\"><br />"
  }`
...
`r if ( nrows_cwa == 0) { 
    ...
    "<br /><a ><img src=\"Output/TX34/CWAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**ECHO reports for facilities:**</font><font size=\"1.5\"><br />"
  }`
...
#clean up data
# SH - CAAviolations <- `violations_CAA_pg5_TX-34` 
...
#clean up data
# SH - CAAinspections <- `inspections_CAA_pg5_TX-34`
# SH - names(CAAinspections)[1] <- "Date"
# SH - CAAinspections <- CAAinspections[-c(20),]
...
# SH - CAAenforcement <- `enforcements_CAA_pg5_TX-34`
# SH - CAAenforcement <- CAAenforcement[-c(20),]
# SH - names(CAAenforcement)[1] <- "Date"
...
#clean up data
# SH - CWAinspections <- `inspections_CWA_pg6_TX-34`
...
# SH - CWAenforcement <- `enforcements_CWA_pg6_TX-34`
# SH - names(CWAenforcement)[1] <- "Date"
