...
USAinspectionsper1000_All <- region$get_usa_per_1000( 'inspections', 2020 )
USAviolationsper1000_All <- region$get_usa_per_1000( 'violations', 2020 )
inflation <- region$get_inflation( 2020 )
CWAper1000 <- region$get_cwa_per_1000( 2020 )
active_facilities <- region$get_active_facilities()
CWAviolations <- region$get_cwa_violations( 2020 )
enforcement <- region$get_enforcements( 2020 )
```
