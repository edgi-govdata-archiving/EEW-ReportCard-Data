...
ggsave("dotplot_TX34.png", dotplot, path=here(), scale = 2, width=8, height=5, units=c("cm"))

```
 
<a ><img src="dotplot_TX34.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
