...
params: 
  cd_state: "MA07"
  full_name: "Massachusetts 7th District"
  state: "MA"
  district: "07"
---
...
cd_percent_bar <- ggplot(ranked_t, aes(fill=Metric, y=V1, x=Program, alpha=Program))+
  geom_bar(position="dodge", stat="identity")+
  scale_fill_manual(values=metric_colors,breaks=c('Violations', 'Viol/Insp', 'Viol/Enf'), guide=guide_legend(breaks=c('Violations', 'Viol/Insp', 'Viol/Enf')))+
...
<ul>
  ...
  <li><h3>CWA Violations - `r grade(ranked$CWA_Viol_Pct)`</h3></li>
  ...
  <li><h3>RCRA Violations - `r grade(ranked$RCRA_Viol_Pct)`</h3></li>
...
<ul>
  <li>More <strong>violations</strong> are worse.</li>
...
if ( nrows_df > 0 ) {
  ...
  CWAinspections[21,3] <- as.character("Biden")
...
if ( nrows_df > 0 ) {
  ...
  CWAenforcement[21,4] <- as.character("Biden")
...
if ( nrows_df > 0 ) {
  ...
  RCRAviolations[21,3] <- as.character("Biden")
...
if ( nrows_df > 0 ) {
  ...
  RCRAinspections[21,3] <- as.character("Biden")
...
if ( nrows_df > 0 ) {
  ...
  RCRAenforcement[21,4] <- as.character("Biden")
