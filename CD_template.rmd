...
params: 
  cd_state: "AL01"
  full_name: "Alabama's 1st District"
  state: "AL"
  district: "01"
---
...
if ( CD == '00' ) {
  map_src <- paste('CD_maps/',params$state,'_map.png',sep='')
} else {
...
For access to the Jupyter Notebooks which pull data from ECHO at the state and congressional district level, click [here](https://colab.research.google.com/github/edgi-govdata-archiving/ECHO-Cross-Program/blob/main/AllPrograms.ipynb). For national data, click [here](https://colab.research.google.com/github/edgi-govdata-archiving/ECHO-Cross-Program/blob/main/ECHO_National.ipynb).
