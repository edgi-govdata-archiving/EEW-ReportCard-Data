...
u <- import( 'Region' )
region <- u$Region(type='Congressional District', value=CD, state=params$state, programs=c('CAA', 'CWA', 'RCRA'))
...
<h3>In `r params$cd_state`, there were <span style="color:#569b5e">`r cd_state_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
if ( hasCWAenforcement ) {
  ...
  no_enforcement <- "<h3>(There is no enforcement or fine data for CWA in this district.)</h3>"
  (iCWAgraph | vCWAgraph)
}
...
pdf_url <- paste("https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/",params$cd_state,"_2020.pdf",sep="")
